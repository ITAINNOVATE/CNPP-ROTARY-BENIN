...
export default async function Home() {
  ...
  const localVideos = [
    { id: 'local-0', title: "DGE Stanislas HACHEME", description: "Gouverneur Elu 2026-2027 du Rotary District 9103.", duration: "", category: "Rotary", language: "Français", video_url: "/capsule dge.mp4" },
    { id: 'local-1', title: "PP Olga KATHEMA ABALLO", description: "Vice Présidente Bénin de la Commission Polio Plus du district 9103.", duration: "", category: "Rotary", language: "Français", video_url: "/capsule olga.mp4" },
    { id: 'local-2', title: "Mohamed BONI SENI", description: "Président du Comité de Liaison Inter Clubs du Bénin (CLIC).", duration: "", category: "Rotary", language: "Français", video_url: "/capsule mohamed.mp4" },
    { id: 'local-3', title: "Kémal-Dine MAMA", description: "Président du club Rotaract de Cotonou Rive Droite", duration: "", category: "Rotary", language: "Français", video_url: "/capsule dine.mp4" },
    ...
    { id: 'local-5', title: "LAIMA Aliou", description: "Facilitateur à PIED ONG", duration: "", category: "Témoignages", language: "PEULH", video_url: "/capsule6.mp4" },
    { id: 'local-6', title: "OUANDO Ameline", description: "Volontaire communautaire et Mère de famille", duration: "", category: "Témoignages", language: "WAMA", video_url: "/capsule7.mp4" },
    { id: 'local-7', title: "IBRAHIM Djihadatou", description: "Volontaire ANPE", duration: "", category: "Témoignages", language: "KOTOKOLI", video_url: "/capsule8.mp4" },
    { id: 'local-8', title: "Maimounatou AROUNA", description: "Jeune femme Leader / Commune de DJOUGOU", duration: "", category: "Témoignages", language: "Dendi", video_url: "/capsule9.mp4" },
    ...
    { id: 'local-11', title: "TINDANOU SOULE BIO KARIMOU", description: "Agent de Santé Communautaire Qualifié Goumori (Banikoara)", duration: "", category: "Témoignages", language: "Bariba", video_url: "/capsule12.mp4" },
      ...
      <header className={styles.header}>
        <div className={`container ${styles.headerContainer}`}>
          ...
          <nav className={styles.desktopNav}>
            ...
            <a href="#ressources" className={styles.navLink}>GALERIE</a>
