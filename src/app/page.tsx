...
export default async function Home() {
  ...
  const localVideos = [
    { id: 'local-0', title: "DGE Stanislas HACHEME", description: "Gouverneur Elu 2026-2027 du Rotary District 9103.", duration: "", category: "Rotary", language: "Français", video_url: "/capsule dge.mp4", thumbnailTime: 30 },
    { id: 'local-1', title: "PP Olga KATHEMA ABALLO", description: "Vice Présidente Bénin de la Commission Polio Plus du district 9103.", duration: "", category: "Rotary", language: "Français", video_url: "/capsule olga.mp4", thumbnailTime: 45 },
    { id: 'local-2', title: "Mohamed BONI SENI", description: "Président du Comité de Liaison Inter Clubs du Bénin (CLIC).", duration: "", category: "Rotary", language: "Français", video_url: "/capsule mohamed.mp4", thumbnailTime: 30 },
